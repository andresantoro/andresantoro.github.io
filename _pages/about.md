...
I am an MSCA Postdoctoral Researcher at the [ISI Foundation](https://www.isi.it/) in Turin, supported by the Marie Curie project "temporalHOI". I work within the [NPLab](https://nplresearch.github.io/) under the mentorship of Prof. [Giovanni Petri](https://lordgrilo.github.io/), and in collaboration with Dr. [Fabrizio De Vico Fallani](https://sites.google.com/site/devicofallanifabrizio/) at INRIA, Paris.
I received my PhD in Applied Mathematics from the [Complex Systems and Networks Group](https://www.qmul.ac.uk/maths/research/complex-systems-and-networks-group/) at Queen Mary University of London, where I worked under the supervision of [Vincenzo Nicosia](https://webspace.maths.qmul.ac.uk/v.nicosia/) and [Lucas Lacasa](https://sites.google.com/view/lucaslacasa/).

Previously, I held position as a Researcher at CENTAI and worked as a Postdoctoral Researcher at the [Neuro-X Institute](https://neuro-x.epfl.ch/en/) at EPFL (Geneva), under the guidance of [Dr. Enrico Amico](https://amicolab.org/) within the MIPlab group of [Prof. Dimitri Van De Ville](https://miplab.epfl.ch/index.php). I have also held research positions at [The Alan Turing Institute](https://www.turing.ac.uk/) (London) and served as a Research Assistant at Queen Mary University of London.
